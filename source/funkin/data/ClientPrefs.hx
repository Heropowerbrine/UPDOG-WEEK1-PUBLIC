...
class ClientPrefs
{
	...
	@saveVar public static var colorblind:Bool = false;

	@saveVar public static var startedUp:Bool = false;

	@saveVar public static var disc_rpc:Bool = false;
	...
	public static function saveSettings()
	{
		...
		save.bind('controls_NMV', 'ninjamuffin99'); // Placing this in a separate save so that it can be manually deleted without removing your Score and stuff
	...
	public static function loadPrefs()
	{
		...
		var save:FlxSave = new FlxSave();
		save.bind('controls_NMV', 'ninjamuffin99');
		if (save != null && save.data != null && save.data.customControls != null)
		{
